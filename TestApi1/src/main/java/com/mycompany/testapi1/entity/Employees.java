...
public class Employees implements Serializable {
    ...
    private Collection<Absents> absentsCollection;
    @OneToMany(mappedBy = "idEmployeer")
    private Collection<Uvoleni> uvoleniCollection;
    @OneToMany(mappedBy = "eployee")
    ...
    public Collection<Absents> getAbsentsCollection() {
        return absentsCollection;
    }

    public void setAbsentsCollection(Collection<Absents> absentsCollection) {
        this.absentsCollection = absentsCollection;
    }

    public Collection<Uvoleni> getUvoleniCollection() {
        return uvoleniCollection;
    }

    public void setUvoleniCollection(Collection<Uvoleni> uvoleniCollection) {
        this.uvoleniCollection = uvoleniCollection;
    }
    ...
    public String toString() {
        return "com.mycompany.testapi1.entity.Employees[ employeeID=" + employeeID + " ]";
    }
