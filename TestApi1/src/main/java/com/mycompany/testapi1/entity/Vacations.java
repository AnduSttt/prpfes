...
public class Vacations implements Serializable {
    ...
    @JsonIgnore
    @JoinColumn(name = "replaces", referencedColumnName = "idApplicant")
    @ManyToOne
    private Applicants replaces;
    @JsonIgnore
    @JoinColumn(name = "eployee", referencedColumnName = "EmployeeID")
    @ManyToOne
    ...
    public String toString() {
        return "com.mycompany.testapi1.entity.Vacations[ idVacation=" + idVacation + " ]";
    }
